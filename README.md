# Cancer-Cell-Classification-Project
...
Features: Cell nucleus measurements
Target:
0 → Malignant
1 → Benign
...
Outcome
The model successfully classifies tumors with high accuracy and demonstrates the use of ML in medical diagnosis.
